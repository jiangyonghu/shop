...
import shop.samll.admin.util.AdminResponseCode;
...
import shop.samll.db.domain.PO.Role;
...
import static shop.samll.admin.util.AdminResponseCode.ROLE_NAME_EXIST;
import static shop.samll.admin.util.AdminResponseCode.ROLE_USER_EXIST;
...
public class AdminRoleController {
    ...
    @GetMapping("/options")
    @ApiOperation(value = "功能树", notes = "显示所有权限功能树（三级分层）")
    ...
    @ApiOperation(value = "角色详情", notes = "角色权限功能树（三级分层）")
    ...
    public Object updatePermissions(@RequestBody String body) {
        ...
        for(String permission : permissions){
            shop.samll.db.domain.PO.Permission Permission= new shop.samll.db.domain.PO.Permission();
