...
public class PermissionUtil {
    ...
    public static List<PermVo> listPermVo(List<Permission> permissions) {
        ...
        for (Permission permission : permissions) {
            ...
            if (perm1 == null) {
                ...
                perm1.setChildren(new ArrayList<PermVo>());
                root.add(perm1);
            }
            ...
            if (perm2 == null) {
                ...
                perm2.setChildren(new ArrayList<PermVo>());
            ...
            //添加api路径 截取最后一个/的值
            perm2.setApi(api.substring(0,api.lastIndexOf('/')));
    ...
    public static List<PermVo> listPermVo(List<Permission> permissions, Set<String> permissionsString) {

        {
            ...
            for (Permission permission : permissions) {
                ...
                if (leftPerm == null) {
                    ...
                    leftPerm.setLabel(requiresPermissionsDesc.button());
                    leftPerm.setApi(api);
                    if(!permissionsString.contains(leftPerm.getId())){
                        continue;
                    }
                    perm2.getChildren().add(leftPerm);
                }
